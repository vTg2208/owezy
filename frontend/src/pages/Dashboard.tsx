      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="space-y-2 text-sm">
            <Link to="/?mode=create" className="block text-blue-700 hover:underline">→ Create a new trip</Link>
            <Link to="/?mode=join" className="block text-blue-700 hover:underline">→ Join an existing trip</Link>
          </div>
        </div>
      </div>
    </div>
